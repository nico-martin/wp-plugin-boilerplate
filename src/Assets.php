...
class Assets
{
    ...
    public function addAssets()
    {
        ...
        wp_enqueue_style(
            PREFIX_get_instance()->prefix . '-ui-style',
            $dir_uri . 'assets/dist/ui.css',
            [],
            $script_version
        );
        wp_enqueue_script(
            PREFIX_get_instance()->prefix . '-ui-script',
    ...
    public function addAdminAssets()
    {
        ...
        wp_enqueue_style(
            PREFIX_get_instance()->prefix . '-admin-style',
            $dir_uri . 'assets/dist/admin.css',
            [],
            $script_version
        );
        wp_enqueue_script(
            PREFIX_get_instance()->prefix . '-admin-script',
        ...
        $defaults = [
            ...
            'restPluginBase'     => trailingslashit(get_rest_url() . PREFIX_get_instance()->api_namespace),
